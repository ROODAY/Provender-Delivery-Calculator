  ...
  $("#skip").click(function(){
    ...
    if (currentPage === 1) {
      ...
      for (var i = 0; i < $loanfields.length; i++) {
        $($loanfields[i]).val($($loanfields[i]).attr("placeholder"))
      }
    }
